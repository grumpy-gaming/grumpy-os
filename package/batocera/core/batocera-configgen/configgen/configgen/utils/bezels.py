...
def getBezelInfos(rom: str | Path, bezel: str, systemName: str, emulator: str) -> BezelInfos | None:
    # by order choose :
    # rom name with specific aspect ratio in the system subfolder of the user directory (gb/mario-640x480.png)
    # rom name in the system subfolder of the user directory (gb/mario.png)
    # rom name with specific aspect ratio in the system subfolder of the system directory (gb/mario-640x480.png)
    # rom name in the system subfolder of the system directory (gb/mario.png)
    # rom name with specific aspect ratio in the user directory (mario-640x480.png)
    # rom name in the user directory (mario.png)
    # rom name with specific aspect ratio in the system directory (mario-640x480.png)
    # rom name in the system directory (mario.png)
    # system name with special graphic in the user directory (gb-90.png)
    # system name with specific aspect ratio in the user directory (gb-640x480.png)
    # system name in the user directory (gb.png)
    # system name with special graphic in the system directory (gb-90.png)
    # system name with specific aspect ratio in the system directory (gb-640x480.png)
    # system name in the system directory (gb.png)
    # default name with specific aspect ratio (default-640x480.png)
    ...
    if altDecoration != "90" and altDecoration != "270":
        ...
        search_paths.append(( f"{SYSTEM_DECORATIONS}/{bezel}/default", True))
    ...
    for entry in search_paths:
        ...
        if overlay_png_file.exists():
            ...
            return {
                ...
                "info": overlay_info_file, 
                "layout": overlay_layout_file, 
                "mamezip": overlay_mamezip_file, 
